...
func (client *StatelessClient) ListMarketProfitAndLoss(params MarketProfitAndLossParams) ([]MarketProfitAndLoss, error) {
	json := []MarketProfitAndLoss{}

	if err := GetSports(client, "listMarketProfitAndLoss", params, &json); err != nil {
