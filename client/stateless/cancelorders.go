...
func (client *StatelessClient) CancelOrders(params CancelOrdersParams) (CancelExecutionReport, error) {
	json := CancelExecutionReport{}

	if err := GetSports(client, "cancelOrders", params, &json); err != nil {
