...
const (
	...
	BT_LINE                       BettingType = "LINE"
	BT_RANGE                      BettingType = "RANGE"
	...
	BT_FIXED_ODDS                 BettingType = "FIXED_ODDS"
)
...
type (
	...
	MarketChange struct {
		MarketID         string           `json:"id,omitempty"`               // Market id
